...
// We create the second tile layer that will be the background of our map. Satellite Streets
...
// We create the second tile layer that will be the background of our map. Light
...
// We create the second tile layer that will be the background of our map. Dark
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  var tectonicPlatesData = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
  ...
  d3.json(tectonicPlatesData).then(function(data) {
    ...
    L.geoJson(data, {
      ...
      weight: 1,
      onEachFeature: function(feature, layer) {
        layer.bindPopup("<h2>" + "Source: " + feature.properties.Source + "</h2>");
      }
